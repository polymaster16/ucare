          ...
          <div class="start-container3">
            ...
            <div class="start-container4" v-if="m1" v-motion-roll-left>
              ...
              <span class="start-text">
                ...
                Congratulations, our contact team will contact you on whatsapp in a few hours, for the next part
              </span>
            </div>
            ...
            <div  v-on:click="contact" 
             class="start-container6" v-if="m2" v-motion-pop>
              <span class="start-text07">
                <span>Message us first 📩</span>
              </span>
            </div>
...
<van-button :loading="loading" @click="validateForm3" class="login-find button">
     ...
     <div  class="start-container4" v-if="m11" v-motion-slide-left>
              ...
              />
              <span class="start-text">
          Congratulations, our contact team will contact you on whatsapp in a few hours
...
const router = useRouter()
    ...
    function contact(){
        window.open(`https://wa.me/654455650?text=Hello, I'm ${clientName} and I want to recruit ${nanny_name}`)
    }
