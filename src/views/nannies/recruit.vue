          ...
          <div class="start-container3">
            ...
            <div class="start-container4" v-if="m1" v-motion-roll-left>
              ...
              <span class="start-text">
               ...
               I'm Sarrah and I'll assist you in the recruitment process of {{ nanny_name }}. 
              </span>
            </div>
            ...
            <div  class="start-container4" v-if="m4" v-motion-slide-left>
              ...
              />
              <span class="start-text">
             To begin, how should we call you?
              </span>
            </div>
...
<button @click="validateForm2" class="login-find button">
     ...
     <div  class="start-container4" v-if="m7" v-motion-slide-left>
              ...
              />
              <span class="start-text">
         We are almost done, proceed to paying the recruitment fees through MOMO/ OM
            ...
            <div @click="pay"
            class="start-container6 " v-if="m8" v-slide-left> 
...
const link = ref('')
    ...
    const validateForm1 =()=>{
      ...
      {
        error1.visible = true;
      error1.message = "Your name cannot be empty";
      } else
     if(whatsapp.value === ""){
        error1.visible = true;
      error1.message = "Please, provide us with a correct whatsapp nm";
      }
      else
     if(whatsapp.value.length !== 9){
        error1.visible = true;
      error1.message = "Your whatsapp num should be in the format: 6XX XXX XXX ";
      }
      else{
    ...
    function pay(){
      window.location.href =  'https://s.htr.cm/m8XD'
    }
